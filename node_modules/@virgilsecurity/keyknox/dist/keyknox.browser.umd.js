(function (global, factory) {
            typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('virgil-crypto')) :
            typeof define === 'function' && define.amd ? define(['exports', 'virgil-crypto'], factory) :
            (global = global || self, factory(global.Keyknox = {}, global.VirgilCrypto));
}(this, function (exports, virgilCrypto) { 'use strict';
            ...
            ***************************************************************************** */
            ...
            var KeyknoxClient = /** @class */ (function () {
                function KeyknoxClient(apiUrl, axiosInstance) {
                    this.axios = axiosInstance || axios$1.create({ baseURL: apiUrl || DEFAULT_BASE_URL });
            ...
            var KeyknoxCrypto = /** @class */ (function () {
                function KeyknoxCrypto(crypto) {
                    this.crypto = crypto || new virgilCrypto.VirgilCrypto();
                }
            ...
            exports.KeyknoxClient = KeyknoxClient;
            exports.KeyknoxCrypto = KeyknoxCrypto;
            exports.CloudKeyStorage = CloudKeyStorage;
            exports.KeyknoxManager = KeyknoxManager;
            exports.SyncKeyStorage = SyncKeyStorage;
            exports.KeyknoxError = KeyknoxError;
            exports.KeyknoxClientError = KeyknoxClientError;
            exports.CloudKeyStorageOutOfSyncError = CloudKeyStorageOutOfSyncError;
            exports.CloudEntryExistsError = CloudEntryExistsError;
            exports.CloudEntryDoesntExistError = CloudEntryDoesntExistError;
            exports.KeyEntryExistsError = KeyEntryExistsError;
            exports.KeyEntryDoesntExistError = KeyEntryDoesntExistError;
