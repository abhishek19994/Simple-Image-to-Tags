...
var Connection = function () {
	...
	createClass(Connection, [{
		...
		value: function send(url, opts) {
			...
			return fetch(this.baseUrl + url, opts).then(function (response) {
				if (!response.ok) {
...
export { createPythia, createBrainKey, BreachProofPassword, PythiaClientError, ProofVerificationFailedError, UnexpectedBreachProofPasswordVersionError };
